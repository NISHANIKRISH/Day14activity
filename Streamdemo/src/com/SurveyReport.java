package com;
	...
	public String toString() {
		return "SurveyReport [surveyId=" + surveyId + ", employeeName=" + employeeName + ", location=" + location
				...
				+ ", getSurveyId()=" + getSurveyId() + ", getEmployeeName()=" + getEmployeeName() + ", getLocation()="
				+ getLocation() + ", getTotal_connection_request()=" + getTotal_connection_request()
				+ ", getNo_of_days_for_request_completion()=" + getNo_of_days_for_request_completion()
				+ ", getAverage_request_per_day()=" + getAverage_request_per_day() + ", getClass()=" + getClass()
